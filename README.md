...
## Example:
I loaded all PDFs in my [Zotero](https://www.zotero.org/tjaeken/library) bibliography into the ```data/raw``` (which are heavily focused on Quantum Communication and Computing), and asked the following quesiton:

**query:** explain atmospheric transmission

It pulled up [this paper](https://doi.org/10.1140/epjqt/s40507-024-00279-1) and replied:
